...
class DemoStates extends React.Component {
  render() {
    ...
    return (
      <div>
        <h6 styleName={"custom.docs-header"}>Demo Managing States with Redux</h6>
        <label
          styleName={"custom.checkbox-label"}
        ...
        <div styleName={"custom.checkbox-label-width10rem"}>
          {checked ? "checked" : "unchecked"}
        </div>
        <div>
          <button onClick={() => dispatch(decNumber())}>&#8810;</button>
          <div styleName={"custom.checkbox-label-width6rem"}>{value}</div>
